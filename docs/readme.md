...
- [Инструкция программиста по работе со виртуальным полигоном для разработки систем управления высокоавтоматизированных транспортных средств (ВАТС)](#инструкция-программиста-по-работе-со-виртуальным-полигоном-для-разработки-систем-управления-высокоавтоматизированных-транспортных-средств-ватс)
  ...
  - [Разработка собственной ноды](#разработка-собственной-ноды)
  - [Редактор карт](#редактор-карт)
  - [Полезные команды](#полезные-команды)
  - [Вопросы и помощь](#вопросы-и-помощь)
...
Проект включает файлы Docker, ROS2 и Webots, которые работают совместно для выполнения задач соревнований. Ознакомьтесь с подробным описанием структуры проекта, чтобы быстрее понять расположение компонентов.
...
Этот раздел содержит полезные команды для управления Docker-контейнерами, отладки и работы с ROS2.

## Вопросы и помощь

Для получения дополнительной информации или помощи создайте Issue на [GitHub](https://github.com/ulstu/robocross.virtual/issues) или свяжитесь с организаторами соревнований.
